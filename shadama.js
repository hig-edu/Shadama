    ...
    function initPrimitiveTable() {
        var data = {
            ...
            "fillSpace": new SymTable([
                ...
                ["param", null, "x"],
                ["param", null, "y"]], true),
            "fillRectangle": new SymTable([
                ["param", null, "xName"],
                ["param", null, "yName"],
                ["param", null, "minX"],
                ["param", null, "maxX"],
                ["param", null, "minY"],
                ["param", null, "maxY"]], true),
...
`
    ...
    if (domTools) {
        ...
        watcherList = documentRoot.querySelector("#watcherList");
...
window.ShadamaFactory = ShadamaFactory
